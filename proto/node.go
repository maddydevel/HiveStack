...
// NodeService is the gRPC service for node agent communication.
type NodeService interface {
    ...
    ListVMs(req *ListVMsRequest) (*ListVMsResponse, error)
}

// NodeServiceClient is the client for the NodeAgent gRPC service.
type NodeServiceClient struct{}

// NewNodeServiceClient creates a new NodeAgent gRPC client.
func NewNodeServiceClient(conn interface{}) *NodeServiceClient {
